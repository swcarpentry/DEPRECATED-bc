...
The `c` function allows to combine its arguments. All the arguments
are *coerced* into a single type:
...
## Matrices
A matrix is a 2-dimensional vector, of a single mode. This is what you
would use to analyze a spreadsheet full of only numbers, or only
words. You can create a matrix with the `matrix` function:
