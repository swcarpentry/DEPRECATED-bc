...
# Fix this one below
# ggplot(iris, aes(Species, Sepal.Length, colour=Species)) + geom_jitter(aes(shape=Species), size=3) + geom_smooth(aes(group=Species))

# Adding layers to plots
ggplot(diamonds, aes(carat, price)) + facet_wrap(~cut) + geom_point() + geom_smooth()
