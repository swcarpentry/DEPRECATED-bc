...
# Boxplots and stip plots, adding layers to plots
...
ggplot(iris, aes(Species, Sepal.Length, colour=Species)) + geom_jitter(aes(shape=Species), size=3)
ggplot(iris, aes(Species, Sepal.Length)) + geom_boxplot()
ggplot(iris, aes(Species, Sepal.Length, colour=Species)) + geom_boxplot() + geom_jitter()
ggplot(iris, aes(Species, Sepal.Length, colour=Species)) + geom_boxplot(alpha=.5) + geom_jitter()
ggplot(iris, aes(Species, Sepal.Length, colour=Species)) + geom_boxplot(alpha=.5) + geom_jitter(aes(shape=Species), size=3)

# Adding layers to scatter plots
ggplot(iris, aes(Sepal.Width, Sepal.Length)) + geom_point()
ggplot(iris, aes(Sepal.Width, Sepal.Length, color=Species)) + geom_point() + geom_smooth()
ggplot(iris, aes(Sepal.Width, Sepal.Length, color=Species)) + geom_point() + facet_wrap(~Species)
ggplot(iris, aes(Sepal.Width, Sepal.Length, color=Species)) + geom_point() + facet_wrap(~Species) + geom_smooth()
ggplot(iris, aes(Sepal.Width, Sepal.Length, color=Species)) + geom_point() + facet_wrap(~Species) + geom_smooth("lm")
...
# multiple values, use a statistic
ggplot(baseball, aes(year, hr)) + stat_summary(fun.y=mean, geom="line")
# plot multiple stats http://sharpstatistics.co.uk/r/ggplot2-guide/
mystats <- function(x) {
...
Let's facet the plot by levels of **clarity**, and add multiple layers to the plot. Here, let's add another layer displaying a smoothed conditional mean using the `geom_smooth()` function.

```{r smoothgam}
ggplot(diamonds, aes(carat, price)) + facet_wrap(~clarity) + geom_point() + geom_smooth()
```
