...
We can manage easily the rows and lines of our matrix `dat`. If we wish to exclude a row or a column from `dat`, we can use the `-` symbol.

```{r}
# Exclude the 5th row
dat[-5,]
# Exclude the 2nd column
dat[,-2]
# Exclude both the 5th row and the 2nd column
dat[-5,-2]
```
