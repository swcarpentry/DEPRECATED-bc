...
workhorse of R. Technically, vectors can be one of several types, including:

* atomic vectors
* lists

although the term "vector" most commonly refers to the atomic types not to
lists, and it is how we use it here.
...
You can also create vectors by directly specifying its content. R will then
...
#### Vectors from sequence of numbers
