...
still use) another shell, C-shell, or Csh. Bash and Csh have similar fearure sets,
but their syntax rules are different and this makes them incompatible with
